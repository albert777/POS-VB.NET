Public Class frmFilterStockIn
    ...
    Private Sub frmFilterStockIn_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
